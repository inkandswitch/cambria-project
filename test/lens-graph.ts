...
describe('registering lenses', () => {
  it('should be able to create a graph', () => {
    ...
    assert.deepStrictEqual(lensGraphSchemas(graph), ['mu'])
  })
  ...
  it('should be able to register some lenses', () => {
    ...
    assert.deepStrictEqual(lensGraphSchemas(graph), ['mu', 'V1', 'V2', 'V3'])
  })
  ...
  it('should compose a lens from a path', () => {
    ...
    assert.deepStrictEqual(lens, [...LensV1toV2, ...LensV2toV3])
  })
})
