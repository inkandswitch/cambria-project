    ...
    .map((op) => {
      ...
      return [
        ...
        ...Object.entries(objectProperties).map(([propName, propSchema]) => {
          ...
          // todo: should we assume the JSON schema always has this default key?
          // (if it was generated by our lenses it should,
          // but would we ever have externally produced json schemas here?)
